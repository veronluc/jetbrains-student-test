...
//    }
    ...
    //    @Test
//    void testEngine() {
//        ScriptFa factory = ScriptEngineManager().getEngineByExtension("kts").factory
//        Assert.assertNotNull(factory)
...
//
    ...
    public void testSimpleEval() throws ScriptException {
        ...
        Object res1 = engine.eval("val x = 3");
        assertNull(res1);
        Object res2 = engine.eval("x + 2");
        assertEquals(5, res2);
    }
//
//    @Test
...
//
//    @Test
//    void testEngineRepeatWithReset() {
...
//    }
//    @Test
//    void `kotlin script evaluation should support functional return types`() {
...
//    }
//}
//    void assertThrows(exceptionClass: Class<*>, body: () -> Unit) {
//        try {
//        body()
